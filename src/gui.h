/*
 * Organiza as duas janelas (Item 3), o histograma (Item 4), os botões
 * de equalização (Item 5) e de resolução (Item 6), o salvamento por
 * tecla (Item 7) e o carregamento de texto (Item 8). gui_run() é chamada por main()
 * depois que a imagem já foi * carregada e convertida para escala de cinza.
 */
 ...
 * `image` (no image_load_as_grayscale). Bloqueia até o usuário fechar
